...
// var element = document.getElementById("createdBy");
const element = document.querySelector('#createdBy');
element.innerHTML += " Milthon";
...
function addToDo() {
  ...
  // let nuevoTodo = new ToDo(toDoInput.value); segunda forma
